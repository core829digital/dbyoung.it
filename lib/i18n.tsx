...
const it = {
  ...
  events: {
    ...
    contactRows: ["booking@dbyoung.it (in attivazione)", "+39 000 000 0000 (in attivazione)", "Risposta entro 24–48h"] as string[],
  ...
  contact: {
    ...
    card2D: "info@dbyoung.it (in attivazione con Resend)",
    name: "Nome",
    email: "Email",
...
const en: Dict = {
  ...
  events: {
    ...
    contactRows: ["booking@dbyoung.it (activating)", "+39 000 000 0000 (activating)", "Reply within 24–48h"] as string[],
  ...
  contact: {
    ...
    card2D: "info@dbyoung.it (activating with Resend)",
    name: "Name",
    email: "Email",
