...
export const metadata = { title: "Termini di utilizzo & Licenze — DBYoung" };
    ...
    <div className="mx-auto max-w-3xl px-4 pb-24 pt-28 md:px-8">
      <Reveal>
        ...
        <div className="mt-8 space-y-6 text-sm leading-relaxed text-white/65">
          <section><h2 className="font-display text-xl font-semibold text-white">1. Oggetto</h2><p className="mt-2">dbyoung.it vende beat, sample pack e servizi live di Dimitri Bouturline (DBYoung). L&apos;acquisto di un file non trasferisce il diritto d&apos;autore, ma una licenza d&apos;uso secondo il piano scelto.</p></section>
          ...
          <section><h2 className="font-display text-xl font-semibold text-white">5. Eventi</h2><p className="mt-2">Le prenotazioni dal calendario sono call conoscitive gratuite. I contratti live (cachet, rider, caparre) sono stipulati separatamente per iscritto.</p></section>
